...
export class ColorService extends BaseService {
    updateColors() {
        if (this.app.IS_CHROMAKEY) {
            ...
            this.app.lowerWallColor = '#00FF00';
        ...
        this.app.supportColor1 = this.app.seatsColor; //seats
        this.app.supportColor2 = this.app.lowerWallColor; //lower wall
        this.app.supportColor3 = this.app.upperWallColor; //upper wall
    }
}